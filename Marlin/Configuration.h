...
#define CUSTOM_MACHINE_NAME "Kingroon KP3 V1.2"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 1280, 1280, 6400, 1520 }
 ...
 *                                      X, Y, Z [, I [, J [, K]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 500, 500, 10000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -9, -40, 0 }
